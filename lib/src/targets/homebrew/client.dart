...
class HomebrewFormula {
  ...
  static String render({
    ...
    final buffer = StringBuffer()
      ..writeln('# typed: strict')
      ..writeln('# frozen_string_literal: true')
      ..writeln()
  ...
  static Version? versionIn(List<int> bytes) {
    ...
    const generatedMarker = '# Generated by rk.';
    const generatedHeader =
        '# typed: strict\n# frozen_string_literal: true\n\n';
    if (!source.startsWith(generatedMarker) &&
  ...
  static void _writeAssets(
    ...
    if (arm != null && intel != null) {
      ...
      // Homebrew only permits URLs inside an OS block when they are nested in
      // an architecture block. The inactive architecture consequently has no
      // URL, but the Formula remains valid Homebrew DSL and the active host
      // selects exactly one immutable archive.
      _writeAssetBlock(
        buffer,
        block: arm != null ? 'on_arm' : 'on_intel',
        asset: arm ?? intel!,
        indent: outer,
        repository: repository,
        tag: tag,
