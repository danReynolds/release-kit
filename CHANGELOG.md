...
- Releases to pub.dev and GitHub Releases, with signed and notarized macOS
  binaries, cross-compiled Linux binaries, notarization evidence published
  beside the archives, and checksums.
- `--rehearse` runs every local step for real — build, sign, notarize,
